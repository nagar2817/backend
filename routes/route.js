...
import {WelcomeRoute,FetchMovies,InsertMovies,getAllgenres,getMovies,getAllMovies,
    ...
    updateWantToWatch,signin,fetchMovieFromFavorites,fetchFavoriteMovies,fetchWantToWatchMovies,fetchWantToWatchFromFavorites} from '../authcontroller/controller.js';
...
router.get('/signin/:username/:email/:password',signin);
